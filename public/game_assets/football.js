    ...
    countdown = setInterval(function() {
        ...
        if (--timer < 0) {
            ...
            if (homeScore > awayScore)
                updateStatus('GAME OVER!<br>Home Team Won!');
            else if (awayScore > homeScore)
                updateStatus('GAME OVER!<br>Away Team Won!');
            else
...
function drawGoalPost() {
    ...
    if (goalDetection(box)) {
        updateScore('home');
        updateStatus('GOAL!<br>Away Team Score!');
        removeStatus();
        resetBall();
        setDelay();
    }
    ...
    if (goalDetection(box)) {
        updateScore('away');
        updateStatus('GOAL!<br>Home Team Score!');
        removeStatus();
        resetBall();
        setDelay();
    }
