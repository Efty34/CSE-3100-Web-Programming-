        ...
        <aside class="sidebar" data-sidebar>
            ...
            <div class="sidebar-info">
                ...
                <figure class="avatar-box">
                    <img src="{{ asset('club_storage/' . $club->{'logo'}) }}" alt="" width="80">
                </figure>

                <div class="info-content">
                    <h1 class="name" title="Richard hanrick">{{ $club->club_name }}</h1>
            ...
            <div class="sidebar-info_more">
                ...
                <ul class="contacts-list">
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <time datetime="1982-06-23">{{ $club->founded_year }}</time>
                        </div>
                ...
                <ul class="social-list">
                    ...
                    <li class="social-item">
                        <a href="{{ $club->social }}" class="social-link">
                    ...
                    <ul class="testimonials-list has-scrollbar">
                        ...
                        <li class="testimonials-item">
                            <div class="content-card" data-testimonials-item>
                                ...
                                <h4 class="h4 testimonials-item-title" data-testimonials-title>League Championship</h4>
                    ...
                    <section class="clients">
                        ...
                        <ul class="clients-list has-scrollbar">
                            ...
                            <li class="clients-item">
                                ...
                                <img id="std-img"
                                    src="{{ asset('club_storage/' . $club->{'stadium_picture'}) }}"
                                    alt="client logo">
                            ...
                            <ul class="service-list">
                                ...
                                @foreach (range(1, 11) as $index)
                                    <li class="service-item">
                                            ...
                                            <div class="service-icon-box">
                                                <form action="{{ route('add.player.to.profile') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="player_name"
                                                        value="{{ $club->{'name' . $index} }}">
                                                    <input type="hidden" name="player_position"
                                                        value="{{ $club->{'position' . $index} }}">
                                        ...
                                        <!-- Display player info -->
                                        <div class="service-content-box">
                                            <h4 class="h4 service-item-title">{{ $club->{'name' . $index} }}
                                            </h4>
                                            <p class="service-item-text">{{ $club->{'position' . $index} }}
                                            </p>
                                        </div>
                                    </li>
                                @endforeach
