        ...
        <aside class="sidebar" data-sidebar>
            ...
            <div class="sidebar-info">
                ...
                <figure class="avatar-box">
                    <img src="{{ asset('laliga_storage/' . $bundes_liga_club->{'logo'}) }}" alt="" width="80">
                </figure>

                <div class="info-content">
                    <h1 class="name" title="Richard hanrick">{{ $bundes_liga_club->club_name }}</h1>
            ...
            <div class="sidebar-info_more">
                ...
                <ul class="contacts-list">
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <time datetime="1982-06-23">{{ $bundes_liga_club->founded_year }}</time>
                        </div>
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <address>{{ $bundes_liga_club->country }}</address>
                        </div>
                ...
                <ul class="social-list">
                    ...
                    <li class="social-item">
                        <a href="{{ $bundes_liga_club->social }}" class="social-link">
                    ...
                    <ul class="service-list">
                        ...
                        <li class="service-item">
                            ...
                            <div class="service-content-box">
                                ...
                                <p class="service-item-text">
                                    {{ $bundes_liga_club->world_ranking }}
                                </p>
                            </div>
                    ...
                    <ul class="testimonials-list has-scrollbar">
                        ...
                        <li class="testimonials-item">
                            <div class="content-card" data-testimonials-item>
                                ...
                                <div class="testimonials-text" data-testimonials-text>
                                    <p>
                                        {{ $bundes_liga_club->champions_league }}
                                    </p>
                                </div>
                        ...
                        <li class="testimonials-item">
                            <div class="content-card" data-testimonials-item>
                                ...
                                <h4 class="h4 testimonials-item-title" data-testimonials-title>German Championship</h4>

                                <div class="testimonials-text" data-testimonials-text>
                                    <p>
                                        {{ $bundes_liga_club->league_trophy }}
                                    </p>
                                </div>
                ...
                <section class="timeline">
                    ...
                    <ol class="timeline-list">
                        ...
                        <li class="timeline-item">
                            ...
                            <span>{{ $bundes_liga_club->manager }}</span>
                        </li>
                    </ol>
                ...
                <section class="timeline">
                    ...
                    <ol class="timeline-list">
                        ...
                        <li class="timeline-item">
                            ...
                            <span>{{ $bundes_liga_club->stadium_name }}</span>
                        ...
                        <li class="timeline-item">
                            ...
                            <span>{{ $bundes_liga_club->capacity }}</span>
                    ...
                    <section class="clients">
                        ...
                        <ul class="clients-list has-scrollbar">
                            ...
                            <li class="clients-item">
                                ...
                                <img id="std-img"
                                    src="{{ asset('laliga_storage/' . $bundes_liga_club->{'stadium_picture'}) }}"
                                    alt="client logo">
                            ...
                            <ul class="service-list">
                                ...
                                @foreach (range(1, 11) as $index)
                                    <li class="service-item">
                                            ...
                                            <div class="service-icon-box">
                                                <form action="{{ route('add.player.to.profile') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="player_name"
                                                        value="{{ $bundes_liga_club->{'name' . $index} }}">
                                                    <input type="hidden" name="player_position"
                                                        value="{{ $bundes_liga_club->{'position' . $index} }}">
                                        ...
                                        <!-- Display player info -->
                                        <div class="service-content-box">
                                            <h4 class="h4 service-item-title">{{ $bundes_liga_club->{'name' . $index} }}
                                            </h4>
                                            <p class="service-item-text">{{ $bundes_liga_club->{'position' . $index} }}
                                            </p>
                                        </div>
                                    </li>
                                @endforeach
