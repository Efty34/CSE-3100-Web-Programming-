                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="position" class="form-control"
                                            placeholder="Position" value="{{ old('position', $player->position) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="profile_image" class="form-control"
                                            placeholder="Upload Image" value="{{ old('profile_image', $player->profile_image) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="birth_date" class="form-control"
                                            placeholder="Birth Date" value="{{ old('birth_date', $player->birth_date) }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="birth_place" class="form-control"
                                            placeholder="Birth Place" value="{{ old('birth_place', $player->birth_place) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="social" class="form-control"
                                            placeholder="Instagram" value="{{ old('social', $player->social) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="preferred_foot" class="form-control"
                                            placeholder="Preferred Foot" value="{{ old('preferred_foot', $player->preferred_foot) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="market_value" class="form-control"
                                            placeholder="Current Market Value" value="{{ old('market_value', $player->market_value) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="outfitter" class="form-control"
                                            placeholder="Outfitter" value="{{ old('outfitter', $player->outfitter) }}" />
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="career_goals" class="form-control"
                                            placeholder="Career Goals" value="{{ old('career_goals', $player->career_goals) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="world_cups" class="form-control"
                                            placeholder="World Cup" value="{{ old('world_cups', $player->world_cups) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="continental_cups" class="form-control"
                                            placeholder="Continental Cup" value="{{ old('continental_cups', $player->continental_cups) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="ballon_dors" class="form-control"
                                            placeholder="Ballon d'OR" value="{{ old('ballon_dors', $player->ballon_dors) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="champions_league" class="form-control"
                                            placeholder="Champions League" value="{{ old('champions_league', $player->champions_league) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="league_titles" class="form-control"
                                            placeholder="League Trophy" value="{{ old('league_titles', $player->league_titles) }}" />
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="club_debut" class="form-control"
                                            placeholder="Club Debut" value="{{ old('club_debut', $player->club_debut) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="current_club" class="form-control"
                                            placeholder="Current Club" value="{{ old('current_club', $player->current_club) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="previous_clubs" class="form-control"
                                            placeholder="Previous Club" value="{{ old('previous_clubs', $player->previous_clubs) }}" />
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="national_team" class="form-control"
                                            placeholder="National Team" value="{{ old('national_team', $player->national_team) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="national_debut" class="form-control"
                                            placeholder="National Debut" value="{{ old('national_debut', $player->national_debut) }}" />
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="overall" class="form-control"
                                            placeholder="Overall" value="{{ old('overall', $player->overall) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="shooting" class="form-control"
                                            placeholder="Shooting" value="{{ old('shooting', $player->shooting) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="passing" class="form-control"
                                            placeholder="Passing" value="{{ old('passing', $player->passing) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="dribbling" class="form-control"
                                            placeholder="Dribling" value="{{ old('dribbling', $player->dribbling) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="defending" class="form-control"
                                            placeholder="Defending" value="{{ old('defending', $player->defending) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="physical" class="form-control"
                                            placeholder="Physical" value="{{ old('physical', $player->physical) }}" />
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="photo1" class="form-control"
                                            placeholder="Upload Image" value="{{ old('photo1', $player->photo1) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="photo2" class="form-control"
                                            placeholder="Upload Image" value="{{ old('photo2', $player->photo2) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="photo3" class="form-control"
                                            placeholder="Upload Image" value="{{ old('photo4', $player->photo3) }}" />
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="photo4" class="form-control"
                                            placeholder="Upload Image"  value="{{ old('photo4', $player->photo4) }}"/>
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="photo5" class="form-control"
                                            placeholder="Upload Image" value="{{ old('photo5', $player->photo5) }}" />
