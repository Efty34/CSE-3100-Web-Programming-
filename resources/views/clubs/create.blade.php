            ...
            <div class="col-md-9 register-right">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="club" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <form action="{{ route('clubs.store', $league->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    {{-- <div class="form-group">
                                        <input type="text" name="leagueid" class="form-control"
                                            placeholder="leagueid" value="{{$league->id}}" />
                                        @if ($errors->has('leagueid'))
                                            <span class="text-danger">{{ $errors->first('leagueid') }}</span>
                                        @endif
