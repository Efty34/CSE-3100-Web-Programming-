        ...
        <aside class="sidebar" data-sidebar>
            ...
            <div class="sidebar-info">
                ...
                <figure class="avatar-box">
                    <img src="{{ asset('laliga_storage/' . $seria_a_club->{'logo'}) }}" alt="" width="80">
                </figure>

                <div class="info-content">
                    <h1 class="name" title="Richard hanrick">{{ $seria_a_club->club_name }}</h1>
            ...
            <div class="sidebar-info_more">
                ...
                <ul class="contacts-list">
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <time datetime="1982-06-23">{{ $seria_a_club->founded_year }}</time>
                        </div>
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <address>{{ $seria_a_club->country }}</address>
                        </div>
                ...
                <ul class="social-list">
                    ...
                    <li class="social-item">
                        <a href="{{ $seria_a_club->social }}" class="social-link">
                    ...
                    <ul class="testimonials-list has-scrollbar">
                        ...
                        <li class="testimonials-item">
                            <div class="content-card" data-testimonials-item>
                                ...
                                <h4 class="h4 testimonials-item-title" data-testimonials-title>Italian Championship</h4>

                                <div class="testimonials-text" data-testimonials-text>
                                    <p>
                                        {{ $seria_a_club->league_trophy }}
                                    </p>
                                </div>
                ...
                <section class="timeline">
                    ...
                    <ol class="timeline-list">
                        ...
                        <li class="timeline-item">
                            ...
                            <span>{{ $seria_a_club->stadium_name }}</span>
                        ...
                        <li class="timeline-item">
                            ...
                            <span>{{ $seria_a_club->capacity }}</span>
                ...
                <section class="timeline">
                    ...
                    <ol class="timeline-list">
                        ...
                        <li class="timeline-item">
                            ...
                            <span>{{ $seria_a_club->manager }}</span>
                        </li>
                    </ol>
                    ...
                    <section class="clients">
                        ...
                        <ul class="clients-list has-scrollbar">
                            ...
                            <li class="clients-item">
                                ...
                                <img id="std-img"
                                    src="{{ asset('laliga_storage/' . $seria_a_club->{'stadium_picture'}) }}"
                                    alt="client logo">
                        ...
                        <section class="service">
                            ...
                            <ul class="service-list">
                                ...
                                {{-- <li class="service-item">
                                    ...
                                    <div class="service-content-box">
                                        <h4 class="h4 service-item-title">{{ $seria_a_club->name1 }}</h4>

                                        <p class="service-item-text">
                                            {{ $seria_a_club->position1 }}
                                        </p>
                                    </div>
